...
AddEventHandler('N1Core:Client:OnPlayerLoaded', function()
    ...
    onDuty = N1Core.Functions.GetPlayerData().job.onduty
    isHandcuffed = false
    TriggerServerEvent("N1Core:Server:SetMetaData", "ishandcuffed", false)
    ...
    if N1Core.Functions.GetPlayerData().metadata["tracker"] then
        ...
        TriggerEvent('N1-clothing:client:loadOutfit', trackerClothingData)
    else
...
AddEventHandler('police:client:SendPoliceEmergencyAlert', function()
    ...
    TriggerServerEvent("police:server:SendPoliceEmergencyAlert", streetLabel, pos, N1Core.Functions.GetPlayerData().metadata["callsign"])
    TriggerServerEvent('N1-policealerts:server:AddPoliceAlert', {
        timeOut = 10000,
        ...
        details = {
            [1] = {
                ...
                detail = MyId .. ' | ' .. N1Core.Functions.GetPlayerData().charinfo.firstname .. ' ' .. N1Core.Functions.GetPlayerData().charinfo.lastname,
            },
            [2] = {
