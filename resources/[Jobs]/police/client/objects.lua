...
AddEventHandler('police:client:spawnCone', function()
    N1Core.Functions.Progressbar("spawn_object", "Place object..", 2500, false, true, {
...
AddEventHandler('police:client:deleteObject', function()
    ...
    if dist < 5.0 then
        N1Core.Functions.Progressbar("remove_object", "Removing object..", 2500, false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
...
AddEventHandler('police:client:SpawnSpikeStrip', function()
    if #SpawnedSpikes + 1 < SpikeConfig.MaxSpikes then
        ...
        N1Core.Functions.Notify('There are no Spikestrips left..', 'error')
    end
end)
