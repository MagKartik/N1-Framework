...
RegisterNetEvent('N1-shops:client:UpdateShop')
AddEventHandler('N1-shops:client:UpdateShop', function(shop, itemData, amount)
    TriggerServerEvent('N1-shops:server:UpdateShopItems', shop, itemData, amount)
end)

RegisterNetEvent('N1-shops:client:SetShopItems')
AddEventHandler('N1-shops:client:SetShopItems', function(shop, shopProducts)
    Config.Locations[shop]["products"] = shopProducts
end)

RegisterNetEvent('N1-shops:client:RestockShopItems')
AddEventHandler('N1-shops:client:RestockShopItems', function(shop, amount)
