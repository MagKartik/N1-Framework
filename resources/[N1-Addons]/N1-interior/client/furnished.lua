...
RegisterNetEvent('N1-interior:client:SetNewState')
AddEventHandler('N1-interior:client:SetNewState', function(bool)
	IsNew = bool
end)
...
function CreateApartmentFurnished(spawn)
	...
	if IsNew then
		SetTimeout(750, function()
			TriggerEvent('N1-clothes:client:CreateFirstCharacter')
			IsNew = false
		end)
	end
    return { objects, POIOffsets }
