...
Citizen.CreateThread(function()
    Wait(500)
    N1Core.Functions.TriggerCallback('N1-methlab:server:GetData', function(data)
                                ...
                                if(GetDistanceBetweenCoords(pos, Config.Ingredients["lab"].coords.x, Config.Ingredients["lab"].coords.y, Config.Ingredients["lab"].coords.z, true) < 1)then
                                    if CarryPackage == nil then
                                        ...
                                        if IsControlJustPressed(0, Keys["E"]) then
                                            ...
                                            N1Core.Functions.Progressbar("pickup_reycle_package", "Grabbing ingredients..", 5000, false, true, {}, {}, {}, {}, function() -- Done
...
RegisterNetEvent('N1-methlab:client:UseLabKey')
AddEventHandler('N1-methlab:client:UseLabKey', function(labkey)
    if ClosestMethlab == Config.CurrentLab then
        ...
        if dist < 1 then
            if labkey == ClosestMethlab then
                ...
                N1Core.Functions.Notify('This isn\'t the right key..', 'error')
            end
        end
    end
end)
