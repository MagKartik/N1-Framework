...
N1.SpawnPoint = {x = -59.18, y = -1109.71, z = 25.45, h = 68.5}
N1.DefaultGarage = "centralgarage"

N1.QuickSell = {x = -46.92, y = -1081.66, z = 26.74, h = 252.5, r = 1.0}
...
N1.DefaultBuySpawn = {x = -56.79, y = -1109.85, z = 26.43, h = 71.5}

N1Custom.VehicleBuyLocation = {x = -772.82, y = -235.39, z = 37.07, h = 201.5, r = 1.0}
N1Custom.ShowroomPositions = {
    [1] = {
        coords = {
            x = -792.46, 
            y = -233.15, 
