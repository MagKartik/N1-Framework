...
RegisterServerEvent('N1-scrapyard:server:LoadVehicleList')
AddEventHandler('N1-scrapyard:server:LoadVehicleList', function()
    local src = source
    TriggerClientEvent("N1-scapyard:client:setNewVehicles", src, Config.CurrentVehicles)
end)


RegisterServerEvent('N1-scrapyard:server:ScrapVehicle')
AddEventHandler('N1-scrapyard:server:ScrapVehicle', function(listKey)
    local src = source 
    ...
    if Config.CurrentVehicles[listKey] ~= nil then 
        ...
        TriggerClientEvent("N1-scapyard:client:setNewVehicles", -1, Config.CurrentVehicles)
    end
end)
