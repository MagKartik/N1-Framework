...
AddEventHandler('N1Core:Client:OnPlayerLoaded', function()
    ...
    N1Core.Functions.TriggerCallback('N1-scoreboard:server:GetConfig', function(config)
    ...
    while true do
        if IsControlJustPressed(0, Config.OpenKey) then
            if not scoreboardOpen then
                N1Core.Functions.TriggerCallback('N1-scoreboard:server:GetPlayersArrays', function(playerList)
                    N1Core.Functions.TriggerCallback('N1-scoreboard:server:GetActivity', function(cops, ambulance)
...
RegisterNetEvent('N1-scoreboard:client:SetActivityBusy')
AddEventHandler('N1-scoreboard:client:SetActivityBusy', function(activity, busy)
