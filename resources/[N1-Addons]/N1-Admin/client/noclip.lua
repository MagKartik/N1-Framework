...
RegisterNetEvent('N1-admin:client:toggleNoclip')
AddEventHandler('N1-admin:client:toggleNoclip', function()
    toggleNoClipMode()
end)
...
Citizen.CreateThread( function()
    ...
    function handleMovement(xVect,yVect)
        if ( IsControlJustPressed( 1, changeSpeedKey ) or IsDisabledControlJustPressed( 1, changeSpeedKey ) ) then
            ...
            N1Core.Functions.Notify("Current speed: ".. speeds[travelSpeed])
