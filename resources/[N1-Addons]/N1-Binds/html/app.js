...
$(document).on('click', '.save-bindings', function(e){
    ...
    $.post('http://N1-commandbinding/save', JSON.stringify({
        keyData: keyData
    }));
});

N1inding.Open = function(data) {
...
N1inding.Close = function() {
    $(".container").fadeOut(150);
    $.post('http://N1-commandbinding/close');
}