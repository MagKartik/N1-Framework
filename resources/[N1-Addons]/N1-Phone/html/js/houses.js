    ...
    if (CurrentHouseData.keyholders !== undefined && CurrentHouseData.keyholders !== null) {
        $.each(CurrentHouseData.keyholders, function(i, keyholder){
            if (keyholder !== null && keyholder !== undefined) {
                var elem;
                if (keyholder.charinfo.firstname !== N1.Phone.Data.PlayerData.charinfo.firstname && keyholder.charinfo.lastname !== N1.Phone.Data.PlayerData.charinfo.lastname) {
...
$(document).on('click', '.house-key-delete', function(e){
    ...
    $.post('http://N1-Phone /RemoveKeyholder', JSON.stringify({
        HolderData: Data,
...
$(document).on('click', '#myhouse-option-transfer-confirm', function(e){
    ...
    $.post('http://N1-Phone /TransferCid', JSON.stringify({
        newBsn: NewBSN,
        HouseData: CurrentHouseData,
        ...
        if (CanTransfer) {
            ...
            N1.Phone.Notifications.Add("fas fa-home", "Houses", "This is an invalid CSN-number", "#27ae60", 2500);
