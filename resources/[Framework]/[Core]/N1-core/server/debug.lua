RegisterServerEvent('N1Core:DebugSomething')
AddEventHandler('N1Core:DebugSomething', function(resource, obj, depth)
...
N1Core.Debug = function(resource, obj, depth)
    TriggerEvent('N1Core:DebugSomething', resource, obj, depth)
end

N1Core.ShowError = function(resource, msg)
    print("\x1b[31m["..resource..":ERROR]\x1b[0m "..msg)
end

N1Core.ShowSuccess = function(resource, msg)
