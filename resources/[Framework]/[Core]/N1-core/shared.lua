...
N1Shared.RandomStr = function(length)
	if length > 0 then
		return N1Shared.RandomStr(length-1) .. StringCharset[math.random(1, #StringCharset)]
	else
		return ''
	end
end

N1Shared.RandomInt = function(length)
	if length > 0 then
		return N1Shared.RandomInt(length-1) .. NumberCharset[math.random(1, #NumberCharset)]
	else
		return ''
	end
end

N1Shared.SplitStr = function(str, delimiter)
	local result = { }
	local from  = 1
