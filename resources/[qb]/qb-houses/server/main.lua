...
QBCore.Functions.CreateUseableItem("police_stormram", function(source, item)
	...
	if (Player.PlayerData.job.name == "police" and Player.PlayerData.job.onduty) then
		...
		TriggerClientEvent('QBCore:Notify', source, "Dit is alleen mogelijk voor hulpdiensten!", "error")
	end
end)
...
QBCore.Commands.Add("ring", "Aanbellen bij huis", {}, false, function(source, args)
    local src = source
    local Player = QBCore.Functions.GetPlayer(src)
