...
QBCore.Commands.Add("deposit", "Stop geld in de kluis", {}, false, function(source, args)
...
QBCore.Commands.Add("withdraw", "Take money out of safe", {}, false, function(source, args)
    local Player = QBCore.Functions.GetPlayer(source)
    local amount = tonumber(args[1]) or 0
